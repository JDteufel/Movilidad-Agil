...
<!DOCTYPE HTML><html>
<head>
  <title>Prendiendo la luz del ESP :)</title>
...
<body>
  <div class="topnav">
    <h1>Prendiendo la luz del ESP :)</h1>
  </div>
  <div class="content">
    <div class="card">
      <h2>Sistemas Digitales</h2>
      <p class="estado">estado: <span id="estado">%Estado%</span></p>
      <p><button id="button" class="button">Activacion</button></p>
    </div>
  </div>
<script>
...
// Función que envía el estado del LED al Arduino UNO usando I2C
void enviarEstadoI2C() {
  Wire.beginTransmission(direccionEsclavo);
  Wire.write(estadoLED);  // Enviar el estado del LED (1 para ON, 0 para OFF)
